...
public partial class UMATextRecipe : UMAPackedRecipeBase
{
	...
	public static List<WardrobeSettings> GenerateWardrobeSet(Dictionary<string, UMATextRecipe> wardrobeRecipes, List<UMAWardrobeCollection> wardrobeCollections, params string[] slotsToSave)
	{
		var thisWardrobeSettings = GenerateWardrobeSet(wardrobeRecipes, slotsToSave);
		for(int i = 0; i < wardrobeCollections.Count; i++)
		{
			thisWardrobeSettings.Add(new WardrobeSettings("WardrobeCollection", wardrobeCollections[i].name));
		}
